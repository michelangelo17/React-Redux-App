...
export const resetComparisonCurrency = () => {
  return { type: RESET_COMPARISON_CURRENCY }
}

export const findSelectedRate = string => {
  return { type: FIND_SELECTED_RATE, payload: string }
}

export const getRates = string => dispatch => {
